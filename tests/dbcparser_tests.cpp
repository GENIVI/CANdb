...
TEST_F(DBCParserTests, empty_lines_before_version)
{
    const auto dbc = R"(
...
TEST_F(DBCParserTests, no_version)
{
    const auto dbc = R"(
...
TEST_F(DBCParserTests, cm_with_semicolon)
{
    const auto dbc = R"(
    CM_ "AUTOGENERATED FILE, DO NOT EDIT";
    )";
...
TEST_F(DBCParserTests, cm_without_semicolon)
{
    const auto dbc = R"(
    CM_ "AUTOGENERATED FILE, DO NOT EDIT"
    )";
...
TEST_F(DBCParserTests, whatever)
{
    const auto dbc = R"(
